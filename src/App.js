    ...
    <>
      <div className="relative  h-full text-black">
        ...
        <div
          className={
            isDark
              ? "leading-7 md:leading-normal  tracking-widest flex flex-col justify-center items-center absolute top-0 h-full w-full text-white bg-black bg-opacity-90"
              : "leading-7 md:leading-normal  tracking-widest flex flex-col justify-center items-center absolute top-0 h-full w-full bg-gray-200 bg-opacity-80"
          }
        >
          <div
            className={
